...
export function DotPattern({
  ...
  gap = 24,
  baseColor = "#404040",
  glowColor = "#F24B0F", // Changed default to brand accent color, assuming it's #F24B0F based on previous CTA styling
  proximity = 120,
  glowIntensity = 1,
  waveSpeed = 0.5,
}: DotPatternProps) {
  ...
  // Gerencia o loop de animação baseado na visibilidade
  useEffect(() => {
